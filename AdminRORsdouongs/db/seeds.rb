...
Nguyenlieu.create!(id: 1,tenNL: 'Nước')
Nguyenlieu.create!(id: 2,tenNL: 'Sữa')
Nguyenlieu.create!(id: 3,tenNL: 'Lá trà')
Nguyenlieu.create!(id: 4,tenNL: 'Đường')
Nguyenlieu.create!(id: 5,tenNL: 'Trân châu trắng')
Nguyenlieu.create!(id: 6,tenNL: 'Trân châu trắng')
Nguyenlieu.create!(id: 7,tenNL: 'Bột hương dâu')
Nguyenlieu.create!(id: 8,tenNL: 'Bột hương lài')
Nguyenlieu.create!(id: 9,tenNL: 'Bột hương cacao')
Nguyenlieu.create!(id: 10,tenNL: 'Socola')
Nguyenlieu.create!(id: 11,tenNL: 'puding')
Nguyenlieu.create!(id: 12,tenNL: 'Rau câu')
Nguyenlieu.create!(id: 13,tenNL: 'Lá trà ô lông')
ThanhphanNguyenlieu.create!(id: 1, nguyenlieu_id: 1, sanpham_id: 1, donvitinh: 'lít', soluong: 0.1)
ThanhphanNguyenlieu.create!(id: 2, nguyenlieu_id: 2, sanpham_id: 1, donvitinh: 'lít', soluong: 0.1)
ThanhphanNguyenlieu.create!(id: 3, nguyenlieu_id: 3, sanpham_id: 1, donvitinh: 'g', soluong: 0.03)
ThanhphanNguyenlieu.create!(id: 4, nguyenlieu_id: 4, sanpham_id: 1, donvitinh: 'g', soluong: 0.02)
ThanhphanNguyenlieu.create!(id: 5, nguyenlieu_id: 1, sanpham_id: 2, donvitinh: 'lít', soluong: 0.1)
ThanhphanNguyenlieu.create!(id: 6, nguyenlieu_id: 2, sanpham_id: 2, donvitinh: 'lít', soluong: 0.1)
ThanhphanNguyenlieu.create!(id: 7, nguyenlieu_id: 13, sanpham_id: 2, donvitinh: 'g', soluong: 0.03)
ThanhphanNguyenlieu.create!(id: 8, nguyenlieu_id: 4, sanpham_id: 2, donvitinh: 'g', soluong: 0.02)
